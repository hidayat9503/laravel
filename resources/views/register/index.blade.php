        ...
        <main class="form-registration">
            ...
            <form action="/register" method="post">
              ...
              <div class="form-floating">
                <input type="text" name="name" id="name" class="form-control rounded-top @error('name') is-invalid @enderror" placeholder="name" value="{{ old('name') }}" required>
            ...
            <small class="d-block text-center mt-3">I have acoount? <a class="text-decoration-none" href="/login">Login!</a></small>
        </main>
    </div>
</div>
@endsection