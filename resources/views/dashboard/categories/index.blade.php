    ...
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $cat->name }}</td>
          <td>
            <a class="badge bg-info" href="/dashboard/posts/{{ $cat->slug }}"><span data-feather="eye"></span></a>
            <a class="badge bg-warning" href="/dashboard/posts/{{ $cat->slug }}/edit"><span data-feather="edit"></span></a>
